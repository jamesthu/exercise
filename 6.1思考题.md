...
Virtual Address 0x748b:
    --> pde index: 0x1d pde contents:(valid 1, pfn 0x0)
      --> pde index: 0x4 pde contents:(valid 0, pfn 0x7f)
        --> Fault (page directory entry not valid)\
